...
def main():
    ...
    while True:
        ...
        while enemigo_actual.salud > 0:
            accion = input("Qué deesas hacer? (atacar/huir): ").lower()
        ...
        if continuar != "s":
         print("Gracias por haber jugador batallas galácticas")
         break

if __name__ == "__main__": #nos asegura que solo podremos ejecutar este script desde el archivo principal
    main()
